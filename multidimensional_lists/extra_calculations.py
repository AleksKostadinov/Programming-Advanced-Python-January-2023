...
print('Primary diagonal:', get_sum_of_primary_diagonal(matrix))
print('Secondary diagonal:', get_sum_of_secondary_diagonal(matrix))
print('Left half:', get_sum_of_left_half(matrix))
print('Right half:', get_sum_of_right_half(matrix))
