...
while firework_effects and explosive_power and not_prepared:
    ...
    if firework_effects[0] <= 0:
        remove_firework_effect = firework_effects.popleft()
        continue
    if explosive_power[-1] <= 0:
        remove_explosive_power = explosive_power.pop()
        continue
    ...
    if fireworks_dict['Crossette Fireworks'] >= 3 and fireworks_dict['Willow Fireworks'] >= 3 \
            and fireworks_dict['Palm Fireworks'] >= 3:
        not_prepared = False
